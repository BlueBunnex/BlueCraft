...
public class EntityMob extends EntityCreature {
	...
	protected Entity findPlayerToAttack() {
		...
		return var1 != null && this.a(var1) ? var1 : null;
	}
	...
	public boolean getCanSpawnHere(double var1, double var3, double var5) {
		...
		if(this.worldObj.getSavedLightValue(EnumSkyBlock.Sky, var7, var8, var9) > this.rand.nextInt(16)) {
			return false;
		} else {
			int var10 = this.worldObj.getBlockLightValue(var7, var8, var9);
			return var10 <= this.rand.nextInt(8) && super.getCanSpawnHere(var1, var3, var5);
		}
	}
}
