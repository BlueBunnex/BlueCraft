...
public class EntityLiving extends Entity {
	...
	public boolean isOnLadder() {
		...
		return this.worldObj.getBlockId(var1, var2, var3) == BlockEntry.ladder.block.blockID || this.worldObj.getBlockId(var1, var2 + 1, var3) == BlockEntry.ladder.block.blockID;
	}
